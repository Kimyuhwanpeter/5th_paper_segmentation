...
FLAGS = easydict.EasyDict({"img_size": 512,
                           ...
                           "pre_checkpoint_path": "C:/Users/Yuhwan/Downloads/67/67",
...
def main():
    ...
    out2 = tf.keras.layers.Conv2D(1, (1,1), name="output_layer_2")(out2)
    out = tf.concat([out, out2], -1, name="output_layer_3")
